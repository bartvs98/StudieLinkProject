...
public class StudentHomeActivity extends AppCompatActivity implements NetworkCommunicationListener, PeerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_landingspage);
...
//                startActivityForResult(bootstrapActivity, 1);
    ...
    public void onClickConnectInstitution(View view) {
...
//        outgoingPeerConnectionListView.setAdapter(outgoingPeerAdapter);
    ...
    public void addInitialPeer() {
        ...
        StudentHomeActivity.CreateInetSocketAddressTask createInetSocketAddressTask = new StudentHomeActivity.CreateInetSocketAddressTask(this);
        try {
    ...
    private static class CreateInetSocketAddressTask extends AsyncTask<String, Void, InetSocketAddress> {
        private WeakReference<StudentHomeActivity> activityReference;

        CreateInetSocketAddressTask(StudentHomeActivity context) {
        ...
        protected InetSocketAddress doInBackground(String... params) {
            ...
            StudentHomeActivity activity = activityReference.get();
