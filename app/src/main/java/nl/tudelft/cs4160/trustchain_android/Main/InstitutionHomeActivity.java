...
public class InstitutionHomeActivity extends AppCompatActivity implements NetworkCommunicationListener, PeerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_institution_landingspage);
...
//    }
    ...
    public void addInitialPeer() {
        ...
        InstitutionHomeActivity.CreateInetSocketAddressTask createInetSocketAddressTask = new InstitutionHomeActivity.CreateInetSocketAddressTask(this);
        try {
    ...
    private static class CreateInetSocketAddressTask extends AsyncTask<String, Void, InetSocketAddress> {
        private WeakReference<InstitutionHomeActivity> activityReference;

        CreateInetSocketAddressTask(InstitutionHomeActivity context) {
        ...
        protected InetSocketAddress doInBackground(String... params) {
            ...
            InstitutionHomeActivity activity = activityReference.get();
...
//        ((TextView) findViewById(R.id.connection_type)).setText(connectionTypeStr);
    ...
    public void updateInternalSourceAddress(final String address) {
        ...
        qrGenerator.generateQRforIP(qrImage, width);
